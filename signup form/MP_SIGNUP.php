...
$first_nameErr = $last_nameErr = $DOBErr = $email_idErr = $contact_number = $gender = $password = $confirm_password = "";
    		...
    		<br>
      		<div class="row">
			    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				  ...
				  <div class="col-sm-10 sign_up_inputs"><input type="date" name="DOB" id="DOB" placeholder="dd/mm/yyyy">
      			...
      			<div class="col-sm-10 sign_up_inputs"><select class="form-control" name="dapartment" id="employee_type">
